...
Use available_groups.json to find the JID for a group. The folder name is auto-generated from the group name as a slug (e.g., "telegram_my-dev-team"). You can override it by providing the folder parameter explicitly.`,
  {
    ...
    folder: z
      ...
      .optional()
      .describe(
        'Channel-prefixed folder name (e.g., "whatsapp_family-chat", "telegram_dev-team"). If omitted, auto-generated from channel + group name slug.',
      ),
  ...
  async (args) => {
    ...
    return {
      content: [
        {
          type: 'text' as const,
          text: `Group "${args.name || args.folder || args.jid}" registration requested. Folder will be auto-generated from group name if not provided.`,
        },
      ],
    };
  },
